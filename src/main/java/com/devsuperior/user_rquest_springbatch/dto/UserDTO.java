package com.devsuperior.user_rquest_springbatch.dto;

import java.time.Instant;
//atributos copiados do programa clients que sera usado as api's. Esse foi do clientDTO
//o userDTO vai receber os dados da plicação clients ClientDTO
